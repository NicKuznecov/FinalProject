...
-->                       
                            ...
                            <table summary="Tournament Bracket" id="TournamentsTable" >
                                <tbody>        
                                    <tr>
                                        <td><p>1. <?php include('queries/ro16_queries/1Ro16Query.php'); echo '<button type="button">Promote('.$row['register_name'].')</button>'?></p></td>
                                    ...
                                    <tr>
                                        <td><p>16. <?php include('queries/ro16_queries/16Ro16Query.php'); echo '<button type="button">Promote('.$row['register_name'].')</button>' ?></p></td>
                                    </tr>
                                    <tr>
