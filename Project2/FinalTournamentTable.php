<!--
File name: FinalTournamentTable.php
Authors name: Nick Kuznecov, Jake Garland
Web-site name: Garlacov Tournaments
File Description: Final Tournament Table page of the Garlacov Tournaments web-site.
-->  
                                        ...
                                        <td rowspan="8"><p>Player: <?php 
                                         ...
                                         $registers_sql = "SELECT
                                                        ...
                                                        AND     (registers.register_number = 6 OR
                                                                ...
                                                                registers.register_number = 14  OR
                                                                registers.register_number = 7  OR
                                                                registers.register_number = 10 OR
